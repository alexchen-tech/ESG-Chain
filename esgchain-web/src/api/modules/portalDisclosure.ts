...
export interface DisclosureFieldKpi {
  slug: string
  label: string
  data_type: 'boolean' | 'numeric' | 'single_choice'
  unit: string | null
  options: DisclosureFieldOption[] | null
...
export const portalDisclosureApi = {
  ...
  save: (payload: { field_slug: string; period_year: number; value: number | boolean | string }) =>
