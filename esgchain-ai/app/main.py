...
from app.api.routes import health, scoring, pcf, pcf_batch, risk, reports, material_emission, scope3, chemicals, regulations, path_risk, risk_suggestion, geo_event, impact, composition, product_pcf
...
app.include_router(product_pcf.router, prefix="/ai/v1")
